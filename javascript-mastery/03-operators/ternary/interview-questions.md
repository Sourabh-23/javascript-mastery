...
Path: `03-operators/ternary/interview-questions.md`

## Beginner

1. What is Ternary?
Answer: Ternary is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.

2. Why do we use Ternary?
