...
Path: `08-loops/for-of/interview-questions.md`

## Beginner

1. What is For Of?
Answer: For Of is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
