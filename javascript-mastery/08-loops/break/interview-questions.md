...
Path: `08-loops/break/interview-questions.md`

## Beginner

1. What is Break?
Answer: Break is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
