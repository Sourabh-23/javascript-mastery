...
Path: `08-loops/for-in/interview-questions.md`

## Beginner

1. What is For In?
Answer: For In is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
