...
Path: `2 ADVANCE JS\09_oop\05_inheritance\03_interview-questions.md`
...
2. How do you debug Inheritance?
...
1. Explain Inheritance in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Inheritance: OOP organizes code using objects, prototypes, classes, and reusable behavior.
