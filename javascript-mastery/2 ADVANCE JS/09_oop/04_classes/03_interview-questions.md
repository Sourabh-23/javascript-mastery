...
Path: `18-oop/classes/interview-questions.md`

## Beginner

1. What is Classes?
Answer: Classes is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
