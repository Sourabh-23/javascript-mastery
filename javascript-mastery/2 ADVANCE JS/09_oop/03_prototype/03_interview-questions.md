...
Path: `18-oop/prototype/interview-questions.md`

## Beginner

1. What is Prototype?
Answer: Prototype is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
