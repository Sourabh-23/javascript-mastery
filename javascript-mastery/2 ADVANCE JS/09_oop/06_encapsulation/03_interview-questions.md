...
Path: `2 ADVANCE JS\09_oop\06_encapsulation\03_interview-questions.md`
...
2. How do you debug Encapsulation?
...
1. Explain Encapsulation in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Encapsulation: OOP organizes code using objects, prototypes, classes, and reusable behavior.
