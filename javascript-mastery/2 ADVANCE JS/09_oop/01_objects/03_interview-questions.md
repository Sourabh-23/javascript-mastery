...
Path: `2 ADVANCE JS\09_oop\01_objects\03_interview-questions.md`

## Basic

1. What is Objects?
Answer: Objects belongs to OOP and should be understood by tracing inputs, operations, and output.
...
1. Explain Objects in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Objects: Objects belongs to OOP and should be understood by tracing inputs, operations, and output.
