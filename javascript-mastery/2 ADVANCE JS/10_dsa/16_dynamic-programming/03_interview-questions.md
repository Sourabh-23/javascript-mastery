...
Path: `2 ADVANCE JS\10_dsa\16_dynamic-programming\03_interview-questions.md`
...
2. How do you debug Dynamic Programming?
...
1. Explain Dynamic Programming in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Dynamic Programming: DSA is about solving problems efficiently using the right algorithm and data structure.
