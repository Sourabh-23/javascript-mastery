...
Path: `2 ADVANCE JS\10_dsa\09_binary-search\03_interview-questions.md`
...
2. How do you debug Binary Search?
...
1. Explain Binary Search in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Binary Search: DSA is about solving problems efficiently using the right algorithm and data structure.
