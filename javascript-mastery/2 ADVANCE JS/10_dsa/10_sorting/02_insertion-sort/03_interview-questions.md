...
Path: `2 ADVANCE JS\10_dsa\10_sorting\02_insertion-sort\03_interview-questions.md`
...
2. Why do we use Insertion Sort?
...
2. How do you debug Insertion Sort?
...
1. Explain Insertion Sort in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Insertion Sort: sort mutates the array; numeric sort needs a compare function.
