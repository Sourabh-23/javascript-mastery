...
Path: `2 ADVANCE JS\10_dsa\10_sorting\01_bubble-sort\03_interview-questions.md`
...
2. How do you debug Bubble Sort?
...
1. Explain Bubble Sort in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Bubble Sort: sort mutates the array; numeric sort needs a compare function.
