...
Path: `2 ADVANCE JS\10_dsa\13_linked-list\06_revision.md`
...
Linked List means: DSA is about solving problems efficiently using the right algorithm and data structure.
