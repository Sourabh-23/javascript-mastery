...
Path: `2 ADVANCE JS\10_dsa\14_tree\03_interview-questions.md`
...
1. Explain Tree in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Tree: DSA is about solving problems efficiently using the right algorithm and data structure.
