...
Path: `2 ADVANCE JS\10_dsa\07_sliding-window\03_interview-questions.md`
...
2. Why do we use Sliding Window?
...
2. How do you debug Sliding Window?
...
1. Explain Sliding Window in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Sliding Window: DSA is about solving problems efficiently using the right algorithm and data structure.
