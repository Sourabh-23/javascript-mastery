...
Path: `19-dsa/graph/interview-questions.md`

## Beginner

1. What is Graph?
Answer: Graph is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.

2. Why do we use Graph?
