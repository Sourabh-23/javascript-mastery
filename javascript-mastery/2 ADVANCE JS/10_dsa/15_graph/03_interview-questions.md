...
Path: `2 ADVANCE JS\10_dsa\15_graph\03_interview-questions.md`
...
1. Explain Graph in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Graph: DSA is about solving problems efficiently using the right algorithm and data structure.
