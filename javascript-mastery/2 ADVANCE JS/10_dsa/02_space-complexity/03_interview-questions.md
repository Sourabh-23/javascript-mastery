...
Path: `2 ADVANCE JS\10_dsa\02_space-complexity\03_interview-questions.md`
...
2. How do you debug Space Complexity?
...
1. Explain Space Complexity in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Space Complexity: DSA is about solving problems efficiently using the right algorithm and data structure.
