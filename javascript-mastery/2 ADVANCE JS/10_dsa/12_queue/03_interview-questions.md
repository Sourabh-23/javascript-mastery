...
Path: `2 ADVANCE JS\10_dsa\12_queue\03_interview-questions.md`
...
1. Explain Queue in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Queue: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
