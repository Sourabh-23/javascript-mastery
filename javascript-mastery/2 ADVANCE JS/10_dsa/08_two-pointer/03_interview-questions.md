...
Path: `2 ADVANCE JS\10_dsa\08_two-pointer\03_interview-questions.md`
...
2. How do you debug Two Pointer?
...
1. Explain Two Pointer in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Two Pointer: DSA is about solving problems efficiently using the right algorithm and data structure.
