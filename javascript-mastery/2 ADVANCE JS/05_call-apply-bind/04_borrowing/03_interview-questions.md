# Borrowing Interview Questions

Path: `2 ADVANCE JS\05_call-apply-bind\04_borrowing\03_interview-questions.md`

## Basic

1. What is Borrowing?
Answer: Borrowing belongs to call apply bind and should be understood by tracing inputs, operations, and output.

2. Why do we use Borrowing?
...
1. Explain Borrowing in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Borrowing: Borrowing belongs to call apply bind and should be understood by tracing inputs, operations, and output.
