...
Path: `2 ADVANCE JS\05_call-apply-bind\03_bind\03_interview-questions.md`
...
1. Explain Bind in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Bind: this depends on how a function is called; call/apply/bind manually control it.
