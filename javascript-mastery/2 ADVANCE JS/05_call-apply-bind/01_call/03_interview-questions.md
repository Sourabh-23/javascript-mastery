# Call Interview Questions

Path: `2 ADVANCE JS\05_call-apply-bind\01_call\03_interview-questions.md`
...
1. Explain Call in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Call: this depends on how a function is called; call/apply/bind manually control it.
