...
Path: `2 ADVANCE JS\02_call-stack\02_stack-behavior\03_interview-questions.md`
...
console.log(run("Stack Behavior"));
```
...
2. How do you debug Stack Behavior?
...
1. Explain Stack Behavior in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Stack Behavior: DSA is about solving problems efficiently using the right algorithm and data structure.
