...
Path: `2 ADVANCE JS\02_call-stack\04_overflow\03_interview-questions.md`

## Basic

1. What is Overflow?
Answer: Overflow belongs to call stack and should be understood by tracing inputs, operations, and output.
...
1. Explain Overflow in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Overflow: Overflow belongs to call stack and should be understood by tracing inputs, operations, and output.
