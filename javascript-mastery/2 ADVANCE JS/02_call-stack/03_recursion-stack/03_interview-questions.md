...
Path: `2 ADVANCE JS\02_call-stack\03_recursion-stack\03_interview-questions.md`
...
console.log(run("Recursion Stack"));
```
...
2. How do you debug Recursion Stack?
...
1. Explain Recursion Stack in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Recursion Stack: DSA is about solving problems efficiently using the right algorithm and data structure.
