# Promise Queue Interview Questions

Path: `2 ADVANCE JS\07_event-loop\06_promise-queue\03_interview-questions.md`

## Basic

1. What is Promise Queue?
Answer: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.

2. Why do we use Promise Queue?
...
2. How do you debug Promise Queue?
...
1. Explain Promise Queue in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Promise Queue: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
