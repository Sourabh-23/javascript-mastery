# Event Loop Working Revision

Path: `2 ADVANCE JS\07_event-loop\07_event-loop-working\06_revision.md`
...
Event Loop Working means: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
