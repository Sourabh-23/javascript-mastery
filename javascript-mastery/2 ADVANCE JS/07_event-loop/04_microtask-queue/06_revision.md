# Microtask Queue Revision

Path: `2 ADVANCE JS\07_event-loop\04_microtask-queue\06_revision.md`
...
Microtask Queue means: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
