...
Path: `2 ADVANCE JS\07_event-loop\01_call-stack\03_interview-questions.md`
...
1. Explain Call Stack in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Call Stack: this depends on how a function is called; call/apply/bind manually control it.
