...
Macrotask Queue ka short interview answer: Event loop sync code, microtasks, timers aur callbacks ka execution order manage karta hai. Saath me ek small example aur common mistake bol doge toh answer strong lagega.
