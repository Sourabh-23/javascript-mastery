...
Path: `16-event-loop/macrotask-queue/interview-questions.md`

## Beginner

1. What is Macrotask Queue?
Answer: Macrotask Queue is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
