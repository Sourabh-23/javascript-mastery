# Macrotask Queue Revision

Path: `2 ADVANCE JS\07_event-loop\05_macrotask-queue\06_revision.md`
...
Macrotask Queue means: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
