...
Path: `2 ADVANCE JS\04_this-keyword\06_interview-traps\03_interview-questions.md`

## Basic

1. What is Interview Traps?
Answer: Interview Traps belongs to this keyword and should be understood by tracing inputs, operations, and output.
...
console.log(run("Interview Traps"));
```
...
2. How do you debug Interview Traps?
...
1. Explain Interview Traps in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Interview Traps: Interview Traps belongs to this keyword and should be understood by tracing inputs, operations, and output.
