...
Path: `2 ADVANCE JS\04_this-keyword\05_strict-mode\03_interview-questions.md`

## Basic

1. What is Strict Mode?
Answer: Strict Mode belongs to this keyword and should be understood by tracing inputs, operations, and output.
...
2. How do you debug Strict Mode?
...
1. Explain Strict Mode in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Strict Mode: Strict Mode belongs to this keyword and should be understood by tracing inputs, operations, and output.
