...
Path: `2 ADVANCE JS\04_this-keyword\04_arrow-this\03_interview-questions.md`
...
1. Explain Arrow This in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Arrow This: this depends on how a function is called; call/apply/bind manually control it.
