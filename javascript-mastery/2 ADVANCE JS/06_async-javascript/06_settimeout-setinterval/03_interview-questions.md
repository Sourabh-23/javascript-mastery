# Settimeout Setinterval Interview Questions

Path: `2 ADVANCE JS\06_async-javascript\06_settimeout-setinterval\03_interview-questions.md`

## Basic

1. What is Settimeout Setinterval?
Answer: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.

2. Why do we use Settimeout Setinterval?
...
console.log(run("Settimeout Setinterval"));
```
...
2. How do you debug Settimeout Setinterval?
...
1. Explain Settimeout Setinterval in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Settimeout Setinterval: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
