# Settimeout Setinterval Revision

Path: `2 ADVANCE JS\06_async-javascript\06_settimeout-setinterval\06_revision.md`
...
Settimeout Setinterval means: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
