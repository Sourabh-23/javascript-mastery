# Async Await Revision

Path: `2 ADVANCE JS\06_async-javascript\05_async-await\06_revision.md`
...
Async Await means: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
