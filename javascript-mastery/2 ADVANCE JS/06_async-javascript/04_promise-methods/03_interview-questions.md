...
Path: `2 ADVANCE JS\06_async-javascript\04_promise-methods\03_interview-questions.md`

## Basic

1. What is Promise Methods?
Answer: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.

2. Why do we use Promise Methods?
...
2. How do you debug Promise Methods?
...
1. Explain Promise Methods in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Promise Methods: async JavaScript handles work that finishes later using callbacks, promises, timers, and the event loop.
