# Global Execution Context Interview Questions

Path: `2 ADVANCE JS\01_execution-context\01_global-execution-context\03_interview-questions.md`

## Basic

1. What is Global Execution Context?
Answer: Global Execution Context belongs to execution context and should be understood by tracing inputs, operations, and output.

2. Why do we use Global Execution Context?
...
2. How do you debug Global Execution Context?
...
1. Explain Global Execution Context in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Global Execution Context: Global Execution Context belongs to execution context and should be understood by tracing inputs, operations, and output.
