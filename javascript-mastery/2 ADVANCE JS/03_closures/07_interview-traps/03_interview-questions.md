...
Path: `2 ADVANCE JS\03_closures\07_interview-traps\03_interview-questions.md`

## Basic

1. What is Interview Traps?
Answer: Interview Traps belongs to closures and should be understood by tracing inputs, operations, and output.
...
Interview Traps: Interview Traps belongs to closures and should be understood by tracing inputs, operations, and output.
