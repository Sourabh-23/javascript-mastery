...
Path: `2 ADVANCE JS\03_closures\06_memoization\03_interview-questions.md`
...
2. How do you debug Memoization?
...
1. Explain Memoization in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Memoization: closure lets an inner function remember variables from its outer scope.
