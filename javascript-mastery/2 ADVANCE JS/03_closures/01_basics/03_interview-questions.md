...
Path: `2 ADVANCE JS\03_closures\01_basics\03_interview-questions.md`

## Basic

1. What is Basics?
Answer: Basics belongs to closures and should be understood by tracing inputs, operations, and output.
...
Basics: Basics belongs to closures and should be understood by tracing inputs, operations, and output.
