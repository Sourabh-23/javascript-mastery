# Custom Errors Interview Questions

Path: `2 ADVANCE JS\08_error-handling\04_custom-errors\03_interview-questions.md`
...
2. How do you debug Custom Errors?
...
1. Explain Custom Errors in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Custom Errors: error handling catches failures, throws meaningful errors, and runs cleanup code.
