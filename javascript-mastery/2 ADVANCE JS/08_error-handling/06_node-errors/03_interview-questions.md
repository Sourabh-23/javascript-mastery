# Node Errors Interview Questions

Path: `2 ADVANCE JS\08_error-handling\06_node-errors\03_interview-questions.md`

## Basic

1. What is Node Errors?
Answer: error handling catches failures, throws meaningful errors, and runs cleanup code.

2. Why do we use Node Errors?
...
2. How do you debug Node Errors?
...
1. Explain Node Errors in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Node Errors: error handling catches failures, throws meaningful errors, and runs cleanup code.
