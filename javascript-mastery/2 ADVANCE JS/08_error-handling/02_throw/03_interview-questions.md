...
Path: `2 ADVANCE JS\08_error-handling\02_throw\03_interview-questions.md`
...
1. Explain Throw in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Throw: error handling catches failures, throws meaningful errors, and runs cleanup code.
