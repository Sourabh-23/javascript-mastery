...
Path: `17-error-handling/try-catch/interview-questions.md`

## Beginner

1. What is Try Catch?
Answer: Try Catch is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
