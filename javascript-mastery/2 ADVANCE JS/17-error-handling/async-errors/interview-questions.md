...
Path: `17-error-handling/async-errors/interview-questions.md`

## Beginner

1. What is Async Errors?
Answer: Async Errors is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
