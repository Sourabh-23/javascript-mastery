...
Path: `18-oop/encapsulation/interview-questions.md`

## Beginner

1. What is Encapsulation?
Answer: Encapsulation is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
