...
Path: `1 SIMPLE JS\04_functions\10_debounce\03_interview-questions.md`
...
1. Explain Debounce in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Debounce: functions package reusable logic and this topic explains one style of creating, calling, or controlling functions.
