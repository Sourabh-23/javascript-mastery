...
Path: `1 SIMPLE JS\05_arrays\02_push-pop\06_revision.md`
...
Push Pop means: arrays store ordered data and this topic explains one way to read, change, search, or transform that data.
