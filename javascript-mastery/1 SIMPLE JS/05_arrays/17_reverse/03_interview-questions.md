...
Path: `1 SIMPLE JS\05_arrays\17_reverse\03_interview-questions.md`
...
1. Explain Reverse in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Reverse: arrays store ordered data and this topic explains one way to read, change, search, or transform that data.
