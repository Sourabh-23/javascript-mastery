...
Path: `1 SIMPLE JS\05_arrays\16_join\06_revision.md`
...
Join means: arrays store ordered data and this topic explains one way to read, change, search, or transform that data.
