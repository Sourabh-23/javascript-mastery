# Splice Interview Questions

Path: `1 SIMPLE JS\05_arrays\13_splice\03_interview-questions.md`

## Basic

1. What is Splice?
Answer: splice mutates the original array by adding/removing/replacing items.

2. Why do we use Splice?
