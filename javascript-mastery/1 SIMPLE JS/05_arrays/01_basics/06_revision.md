...
Path: `1 SIMPLE JS\05_arrays\01_basics\06_revision.md`
...
Basics means: arrays store ordered data and this topic explains one way to read, change, search, or transform that data.
