...
Path: `1 SIMPLE JS\05_arrays\14_concat\06_revision.md`
...
Concat means: arrays store ordered data and this topic explains one way to read, change, search, or transform that data.
