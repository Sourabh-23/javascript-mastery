...
Path: `1 SIMPLE JS\05_arrays\03_shift-unshift\06_revision.md`
...
Shift Unshift means: arrays store ordered data and this topic explains one way to read, change, search, or transform that data.
