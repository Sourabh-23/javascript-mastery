...
Path: `1 SIMPLE JS\05_arrays\03_shift-unshift\03_interview-questions.md`
...
2. How do you debug Shift Unshift?
...
1. Explain Shift Unshift in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Shift Unshift: arrays store ordered data and this topic explains one way to read, change, search, or transform that data.
