# String Modification Revision

Path: `1 SIMPLE JS\06_strings\06_string-modification\06_revision.md`
...
String Modification means: string stores text and is immutable, so methods return new strings instead of changing the original.
