# String Questions Revision

Path: `1 SIMPLE JS\06_strings\08_string-questions\06_revision.md`
...
String Questions means: string stores text and is immutable, so methods return new strings instead of changing the original.
