...
Path: `1 SIMPLE JS\06_strings\01_basics\03_interview-questions.md`

## Basic

1. What is Basics?
Answer: Basics belongs to strings and should be understood by tracing inputs, operations, and output.
...
Basics: Basics belongs to strings and should be understood by tracing inputs, operations, and output.
