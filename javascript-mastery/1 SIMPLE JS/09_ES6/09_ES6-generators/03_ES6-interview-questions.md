...
Path: `1 SIMPLE JS\09_ES6\09_ES6-generators\03_ES6-interview-questions.md`

## Basic

1. What is Generators?
Answer: Generators belongs to ES6 and should be understood by tracing inputs, operations, and output.
...
1. Explain Generators in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Generators: Generators belongs to ES6 and should be understood by tracing inputs, operations, and output.
