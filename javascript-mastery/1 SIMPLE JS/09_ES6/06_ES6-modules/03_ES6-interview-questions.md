...
Path: `1 SIMPLE JS\09_ES6\06_ES6-modules\03_ES6-interview-questions.md`

## Basic

1. What is Modules?
Answer: Modules belongs to ES6 and should be understood by tracing inputs, operations, and output.
...
1. Explain Modules in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Modules: Modules belongs to ES6 and should be understood by tracing inputs, operations, and output.
