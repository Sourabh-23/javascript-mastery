...
Path: `1 SIMPLE JS\09_ES6\01_ES6-let-const\06_ES6-revision.md`

## Must Remember

- let is block scoped and can be reassigned, but cannot be used before declaration because of TDZ.
...
Let Const means: let is block scoped and can be reassigned, but cannot be used before declaration because of TDZ.
