...
Path: `09-es6/destructuring/interview-questions.md`

## Beginner

1. What is Destructuring?
Answer: Destructuring is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
