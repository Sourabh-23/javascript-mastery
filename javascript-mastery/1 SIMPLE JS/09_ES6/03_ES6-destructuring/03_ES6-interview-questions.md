...
Path: `1 SIMPLE JS\09_ES6\03_ES6-destructuring\03_ES6-interview-questions.md`

## Basic

1. What is Destructuring?
Answer: Destructuring belongs to ES6 and should be understood by tracing inputs, operations, and output.
...
Destructuring: Destructuring belongs to ES6 and should be understood by tracing inputs, operations, and output.
