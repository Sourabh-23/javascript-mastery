...
Path: `1 SIMPLE JS\09_ES6\02_ES6-template-literals\03_ES6-interview-questions.md`

## Basic

1. What is Template Literals?
Answer: Template Literals belongs to ES6 and should be understood by tracing inputs, operations, and output.
...
console.log(run("Template Literals"));
```
...
2. How do you debug Template Literals?
...
1. Explain Template Literals in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Template Literals: Template Literals belongs to ES6 and should be understood by tracing inputs, operations, and output.
