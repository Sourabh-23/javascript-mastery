...
Path: `08-loops/for/interview-questions.md`

## Beginner

1. What is For?
Answer: For is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
