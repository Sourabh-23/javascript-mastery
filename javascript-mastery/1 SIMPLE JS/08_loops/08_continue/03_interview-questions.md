...
Path: `08-loops/continue/interview-questions.md`

## Beginner

1. What is Continue?
Answer: Continue is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
