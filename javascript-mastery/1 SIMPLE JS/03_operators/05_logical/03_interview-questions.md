...
Path: `03-operators/logical/interview-questions.md`

## Beginner

1. What is Logical?
Answer: Logical is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
