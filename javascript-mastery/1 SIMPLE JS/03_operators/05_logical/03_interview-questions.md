...
Path: `1 SIMPLE JS\03_operators\05_logical\03_interview-questions.md`

## Basic

1. What is Logical?
Answer: Logical belongs to operators and should be understood by tracing inputs, operations, and output.

2. Why do we use Logical?
...
1. Explain Logical in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Logical: Logical belongs to operators and should be understood by tracing inputs, operations, and output.
