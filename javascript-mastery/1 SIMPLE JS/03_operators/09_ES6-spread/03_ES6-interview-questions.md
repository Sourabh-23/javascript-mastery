...
Path: `1 SIMPLE JS\03_operators\09_ES6-spread\03_ES6-interview-questions.md`

## Basic

1. What is Spread?
Answer: Spread belongs to operators and should be understood by tracing inputs, operations, and output.

2. Why do we use Spread?
...
1. Explain Spread in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Spread: Spread belongs to operators and should be understood by tracing inputs, operations, and output.
