...
Path: `1 SIMPLE JS\03_operators\01_arithmetic\03_interview-questions.md`

## Basic

1. What is Arithmetic?
Answer: Arithmetic belongs to operators and should be understood by tracing inputs, operations, and output.

2. Why do we use Arithmetic?
...
1. Explain Arithmetic in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Arithmetic: Arithmetic belongs to operators and should be understood by tracing inputs, operations, and output.
