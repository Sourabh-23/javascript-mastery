...
Path: `1 SIMPLE JS\03_operators\03_comparison\03_interview-questions.md`

## Basic

1. What is Comparison?
Answer: Comparison belongs to operators and should be understood by tracing inputs, operations, and output.
...
1. Explain Comparison in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Comparison: Comparison belongs to operators and should be understood by tracing inputs, operations, and output.
