# Spread Rest Interview Questions

Path: `09-es6/spread-rest/interview-questions.md`

## Beginner

1. What is Spread Rest?
Answer: Spread Rest is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.

2. Why do we use Spread Rest?
