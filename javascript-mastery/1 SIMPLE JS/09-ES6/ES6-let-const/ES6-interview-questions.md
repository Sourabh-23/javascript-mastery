...
Path: `09-es6/let-const/interview-questions.md`

## Beginner

1. What is Let Const?
Answer: Let Const is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
