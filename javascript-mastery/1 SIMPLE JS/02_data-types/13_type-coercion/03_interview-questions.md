...
Path: `1 SIMPLE JS\02_data-types\13_type-coercion\03_interview-questions.md`

## Basic

1. What is Type Coercion?
Answer: type coercion is JavaScript automatically changing types during operations.

2. Why do we use Type Coercion?
...
2. How do you debug Type Coercion?
...
1. Explain Type Coercion in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Type Coercion: type coercion is JavaScript automatically changing types during operations.
