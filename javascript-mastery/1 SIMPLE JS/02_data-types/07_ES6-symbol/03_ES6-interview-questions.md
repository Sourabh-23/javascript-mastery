...
Path: `1 SIMPLE JS\02_data-types\07_ES6-symbol\03_ES6-interview-questions.md`

## Basic

1. What is Symbol?
Answer: Symbol belongs to data types and should be understood by tracing inputs, operations, and output.

2. Why do we use Symbol?
...
1. Explain Symbol in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Symbol: Symbol belongs to data types and should be understood by tracing inputs, operations, and output.
