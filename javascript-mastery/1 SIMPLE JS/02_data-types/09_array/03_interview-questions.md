...
Path: `1 SIMPLE JS\02_data-types\09_array\03_interview-questions.md`

## Basic

1. What is Array?
Answer: Array belongs to data types and should be understood by tracing inputs, operations, and output.

2. Why do we use Array?
...
1. Explain Array in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Array: Array belongs to data types and should be understood by tracing inputs, operations, and output.
