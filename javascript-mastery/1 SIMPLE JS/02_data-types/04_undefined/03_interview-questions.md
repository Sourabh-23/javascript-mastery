...
Path: `1 SIMPLE JS\02_data-types\04_undefined\03_interview-questions.md`

## Basic

1. What is Undefined?
Answer: undefined means a variable or property exists but currently has no assigned value.

2. Why do we use Undefined?
...
1. Explain Undefined in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Undefined: undefined means a variable or property exists but currently has no assigned value.
