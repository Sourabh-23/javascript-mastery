...
Path: `1 SIMPLE JS\07_objects\02_properties\03_interview-questions.md`
...
1. Explain Properties in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Properties: objects store key-value data and this topic explains one way to read, update, copy, or protect that data.
