...
Path: `1 SIMPLE JS\07_objects\05_ES6-spread-rest\03_ES6-interview-questions.md`
...
2. How do you debug Spread Rest?
...
1. Explain Spread Rest in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Spread Rest: objects store key-value data and this topic explains one way to read, update, copy, or protect that data.
