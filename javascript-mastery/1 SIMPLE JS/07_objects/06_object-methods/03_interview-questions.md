...
Path: `1 SIMPLE JS\07_objects\06_object-methods\03_interview-questions.md`

## Basic

1. What is Object Methods?
Answer: objects store key-value data and this topic explains one way to read, update, copy, or protect that data.

2. Why do we use Object Methods?
...
2. How do you debug Object Methods?
...
1. Explain Object Methods in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Object Methods: objects store key-value data and this topic explains one way to read, update, copy, or protect that data.
