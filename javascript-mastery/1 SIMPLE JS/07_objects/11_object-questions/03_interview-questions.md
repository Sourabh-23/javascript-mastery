# Object Questions Interview Questions

Path: `1 SIMPLE JS\07_objects\11_object-questions\03_interview-questions.md`

## Basic

1. What is Object Questions?
Answer: objects store key-value data and this topic explains one way to read, update, copy, or protect that data.

2. Why do we use Object Questions?
...
2. How do you debug Object Questions?
...
1. Explain Object Questions in runtime terms.
Answer: First identify what is created, then trace how JavaScript executes each line and what value is returned.

## One Line Revision

Object Questions: objects store key-value data and this topic explains one way to read, update, copy, or protect that data.
