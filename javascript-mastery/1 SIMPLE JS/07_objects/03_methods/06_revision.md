...
Path: `1 SIMPLE JS\07_objects\03_methods\06_revision.md`
...
Methods means: objects store key-value data and this topic explains one way to read, update, copy, or protect that data.
