...
Path: `07-objects/methods/interview-questions.md`

## Beginner

1. What is Methods?
Answer: Methods is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
