# Computed Properties Revision

Path: `1 SIMPLE JS\07_objects\10_ES6-computed-properties\06_ES6-revision.md`
...
Computed Properties means: objects store key-value data and this topic explains one way to read, update, copy, or protect that data.
