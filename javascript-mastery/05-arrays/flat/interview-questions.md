# Flat Interview Questions

Path: `05-arrays/flat/interview-questions.md`

## Beginner

1. What is Flat?
Answer: Flat is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.

2. Why do we use Flat?
