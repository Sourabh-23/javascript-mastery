...
Path: `09-es6/modules/interview-questions.md`

## Beginner

1. What is Modules?
Answer: Modules is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
