...
Path: `19-dsa/dynamic-programming/interview-questions.md`

## Beginner

1. What is Dynamic Programming?
Answer: Dynamic Programming is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
...
1. What is one common mistake with Dynamic Programming?
Answer: Reading the code without tracing scope, value, or execution order.

2. How do you debug Dynamic Programming issues?
Answer: Create a small snippet, log values step by step, and explain why each line runs.

## Advanced

1. Explain Dynamic Programming in terms of memory and execution.
