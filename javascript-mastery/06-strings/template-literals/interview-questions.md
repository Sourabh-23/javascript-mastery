# Template Literals Interview Questions

Path: `06-strings/template-literals/interview-questions.md`

## Beginner

1. What is Template Literals?
Answer: Template Literals is a JavaScript topic. Learn the basic idea first, then run the snippet and practice questions.
...
1. What is one common mistake with Template Literals?
Answer: Reading the code without tracing scope, value, or execution order.

2. How do you debug Template Literals issues?
Answer: Create a small snippet, log values step by step, and explain why each line runs.

## Advanced

1. Explain Template Literals in terms of memory and execution.
